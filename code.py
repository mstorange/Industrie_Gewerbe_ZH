...
if submitted:  
    ...
    igfrei['GoogleMaps'] = igfrei.apply(get_gmaps_links,axis=1)
    igbebaut['GoogleMaps'] = igbebaut.apply(get_gmaps_links,axis=1)
    ...
    ">
        ...
        <p>Die Karte zeigt alle Zürcher Industrie und Gewerbe-Parzellen, welche die folgenden Bedingungen erfüllen:<br> - Parzellfläche von {flmin} bis {flmax} m2<br> - ÖV-Güteklasse mindestens {guteklasse_min_wert}<br> - BMZ (min.) ab {bmz_min} m3/m2<br> - Höhe (min) ab {hoehe_min} m<br> - Neuere Gebäude ab Baujahr {jahrmax} oder jünger</p>
    </div>
    '''
